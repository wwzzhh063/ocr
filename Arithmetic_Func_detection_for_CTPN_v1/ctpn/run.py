...
from Arithmetic_Func_detection_for_CTPN_v1.lib.networks.factory import get_network
from Arithmetic_Func_detection_for_CTPN_v1.lib.fast_rcnn.config import cfg, cfg_from_file
from Arithmetic_Func_detection_for_CTPN_v1.lib.fast_rcnn.test import test_ctpn, run
from Arithmetic_Func_detection_for_CTPN_v1.lib.utils.timer import Timer
from Arithmetic_Func_detection_for_CTPN_v1.lib.text_connector.detectors import TextDetector
from Arithmetic_Func_detection_for_CTPN_v1.lib.text_connector.text_connect_cfg import Config as TextLineCfg
from Arithmetic_Func_detection_for_CTPN_v1.lib.text_connector.bbox_connector import BboxConnector
...
def run_ctpn(img):
    cfg_from_file('Arithmetic_Func_detection_for_CTPN_v1/ctpn/text.yml')
    ...
    return  run_list, feed_dict, img_resized.shape, im_scales, bbox_scale
