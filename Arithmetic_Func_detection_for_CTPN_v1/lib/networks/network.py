...
from Arithmetic_Func_detection_for_CTPN_v1.lib.rpn_msr.proposal_layer_tf import proposal_layer as proposal_layer_py
from Arithmetic_Func_detection_for_CTPN_v1.lib.rpn_msr.anchor_target_layer_tf import anchor_target_layer as anchor_target_layer_py
